...
class AccuracyScorer(SentenceLevelScorer):
    ...
    def update(self, results):
        super(AccuracyScorer, self).update(results)
        self._probs.append(str(results['probs']))
        self._reprs.append(str(results['reprs']))
        self._logits.append(str(results['logits']))
...
class F1Scorer(SentenceLevelScorer):
    ...
    def update(self, results):
        super(F1Scorer, self).update(results)
        self._probs.append(str(results['probs']))
        self._reprs.append(str(results['reprs']))
        self._logits.append(str(results['logits']))
...
class MCCScorer(SentenceLevelScorer):
    ...
    def update(self, results):
        super(MCCScorer, self).update(results)
        self._probs.append(str(results['probs']))
        self._reprs.append(str(results['reprs']))
        self._logits.append(str(results['logits']))
